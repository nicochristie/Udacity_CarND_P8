...
### Side note
A lot of time was invested in fine tuning parameters, and the Workspace wasn't exactly collaborative on this, since constant switching between Standard and GPU mode was necessary to compile in one and simulate on the other one. I would strongly recommend investing a few more minutes/hours in a local development environment.
